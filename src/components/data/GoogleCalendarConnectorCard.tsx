...
export default function GoogleCalendarConnectorCard({ connector, onRefresh }: Props) {
    ...
    >
      <div className="hubspot-card-header">
        ...
        <div className="hubspot-card-title-row">
          <span className="data-connector-name">Google Calendar</span>
          {isConnected && (
      ...
      <div className="data-connector-body">
        <div className="data-connector-desc">
          {isConnected
            ...
            : isError
              ...
              : "Sync meetings and events, auto-log activities to CRM records"}
        </div>
        ...
        {syncing && syncSteps.length === 0 && (
          <div className="hubspot-sync-progress">
            ...
            <span className="hubspot-sync-progress-label">Connecting to Google Calendar...</span>
          </div>
        )}
              ...
              return (
                <div key={key} className="hubspot-result-card">
                  ...
                  <div className="hubspot-result-card-stats">
                    ...
                    {r.skipped > 0 && <span className="hubspot-result-stat hubspot-result-stat-skipped">{r.skipped} unchanged</span>}
